...
public class CashReg
{
   ...
   */
   public Change giveChange()
   {
       ...
       int dol = changeAmount / 100;
       changeAmount %= 100;
       int qua = changeAmount / 25;
       changeAmount %= 25;
       int dim = changeAmount / 10;
       changeAmount %= 10;
       int nic = changeAmount / 5;
       changeAmount %= 5;
       int pen = changeAmount / 1;
       Change change = new Change(dol, qua, dim, nic, pen);
       payment = 0;
       purchase = 0;
       return change;
   }
