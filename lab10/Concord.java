...
public class Concord {
	...
	public void printSorted(PrintStream out) {
		...
		for(Map.Entry<String, Integer> ent : concord.entrySet()) {
			list.add(ent);
		}
	 ...
	 * @param pred
	 *            the predicate that each entry is tested on.
	 */
	...
	public void printLongest(PrintStream out, Predicate pred) {
		ArrayList<Map.Entry<String, Integer>> list = new ArrayList<Map.Entry<String,Integer>>();
		for(Map.Entry<String, Integer> entry : concord.entrySet()) {
			if (pred.predicate(entry)) {
				list.add(entry);
		...
		EntryLengthComparator comparator = new EntryLengthComparator();
		Collections.sort(list, comparator);
